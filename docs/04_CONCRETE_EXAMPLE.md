...
This is a real-world example of how to use panosse to clean, encode, normalize,
and verify a FLAC music library.

It will use the panosse's Docker image to process the files.
